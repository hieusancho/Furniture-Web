...
const ProductSlider = () => {
  ...
  //pagination: phân trang (trang 1,2,...)
  //navigation: hiện mũi tên trc sau
  ...
  return <Swiper 
    ...
    {pages.map((page,index)=>{
      ...
      return <div className='w-full max-w-[290px] h-[380px] text-left ' key={index}>
                ...
                <div className='border hover:border-accent rounded-[18px] w-full max-w-[285px] h-full max-h-[292px] flex item-center 
                                justify-center mb-[15px] relative transition'>

                  <img src={image.type} alt=""/>

                  <div className='absolute bottom-4 right-[22px] bg-gray-200 w-8 h-8 rounded-full flex justify-center item-center cursor-pointer transition'>
